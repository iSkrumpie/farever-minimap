...
constexpr std::size_t OFF_GO_POSX           = 152;   // v0.5.5 +8 shift
constexpr std::size_t OFF_GO_POSY           = 160;   // v0.5.5 +8 shift
constexpr std::size_t OFF_INTERACT_STATEID  = 656;   // Chest.stateId — v0.5.5 +8 shift
